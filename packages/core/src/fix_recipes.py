...
def process_file(filepath):
    ...
    # the showcase might import it from @astrake/lumora-ui or from ../../core
    content = re.sub(r'import\s+{\s*useLumoraConfig\s*}\s+from\s+[\'"]@astrake/lumora-ui[\'"];\n', '', content)
...
for root, dirs, files in os.walk('c:/xLab/xlab26/lumora/LumoraUI/apps/showcase/src/recipes'):
    for file in files:
