...
0.8.0
```
Increment it using semantic versioning specifications (e.g. bump `0.8.0` to `0.8.1` or `0.9.0` depending on changes).
...
- **`ci.yml`**: Fired on every pull request and push to verify code syntax. Runs type checking and `bun test`.
